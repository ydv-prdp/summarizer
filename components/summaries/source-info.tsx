...
const SourceInfo = ({fileName,originalFileUrl, title, summaryText, createdAt}:{fileName:string; originalFileUrl:string; title:string; summaryText:string; createdAt:string}) => {
  return (
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            ...
            <div className="flex gap-2">
                ...
                >   
                    <a href={originalFileUrl} target="_blank" rel="nooopener noreferrer">
